<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . "/proyecto/adminUsers.php";
...
<html lang="es">
    ...
    <body>
                            ...
                            <?php foreach ($users as $user) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        data-id="<?php echo $user['id'] ?>" data-nombre="<?php echo $user['Nombre'] ?>"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
        ...
        <!-- MODAL CREAR USUARIO -->
        <div class="modal fade" id="crearUsuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="crearUsuarioModal" aria-hidden="true">
        ...
        <div class="modal fade" id="borrarUsuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="borrarUsuarioModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="borrarUsuarioModal">¿Estás seguro de querer eliminar este usuario?</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p></p>
