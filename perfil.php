            ...
            <div class="col-6">
                <div class="card tarjeta">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <h3 class="card-title nombre">Nickname</h3>
                                <p class="card-text texto">Nombre</p>
                                <p class="card-text texto">Apellidos</p>
                                <p class="card-text texto">Correo</p>
                            </div>
                            <div class="col-4 img">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_BaZoyVktFYPThE20UyemfbmXiD2h0s-Gp5c7K8GhLyxhGIQZgKYkadRvLJHIFbXFAMA&usqp=CAU" class="rounded-circle img-fluid">
                            </div>
                        </div>
                        <br>
                        <div class="row">
