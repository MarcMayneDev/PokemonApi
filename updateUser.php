<?php
    ...
    require $_SERVER['DOCUMENT_ROOT'] . "/proyecto/conectarBD.php";
    require_once $_SERVER['DOCUMENT_ROOT'] . "/proyecto/cerrarBD.php";
    ...
    try {
        ...
        $sentencia = $conn->prepare('UPDATE Usuarios SET nombre = :nombre, apellido = :apellido, nickname = :nickname, password = :password, correo = :correo WHERE id = :id');
    ...
    // Finalmente, cerramos la conexión con la BD
        ...
        header('Location: /proyecto/admin.php');
    }
?>